...
export const WORLDS = [
  ...
  { id:'world-3', order:3, name:WORLD_NAMES[2], theme:'crystal-lake', palette:['#bde7ff','#d8f4ff','#b8d5ff'], skyType:'clear', terrain:'lake', thumbnail:'linear-gradient(135deg,#91d5ff,#8aa8ff)', levels:levels(['slow_zone','escape','vehicle_dash']) },
  ...
  { id:'world-5', order:5, name:WORLD_NAMES[4], theme:'pastel-port', palette:['#ffd8bf','#cbe7ff','#ffe9f2'], skyType:'sunset', terrain:'port', thumbnail:'linear-gradient(135deg,#ffc9a2,#9fd8ff)', levels:levels(['city_quest','escape','time_attack']) },
  ...
  { id:'world-9', order:9, name:WORLD_NAMES[8], theme:'aurora-mountain', palette:['#87a4d5','#5b72a3','#7ed9c2'], skyType:'aurora', terrain:'mountain', thumbnail:'linear-gradient(135deg,#5d7ec2,#6ed6ba)', levels:levels(['mountain_jump','escape','vehicle_dash']) },
  ...
  { id:'world-11', order:11, name:'Ciudad Neón', theme:'neon-city', palette:['#ff66cc','#7c4dff','#00d4ff','#ffd066'], skyType:'neon-night', terrain:'city-neon', thumbnail:'linear-gradient(135deg,#7c4dff,#ff66cc,#00d4ff)', secret:true, levels:levels(['city_quest','escape','finale']) }
];
