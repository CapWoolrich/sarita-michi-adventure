...
export const WORLDS = [
  { id:'world-1', order:1, name:WORLD_NAMES[0], theme:'mystic-forest', palette:['#d7f5bf','#fef5c5','#c6ebdb'], skyType:'day', terrain:'forest-path', thumbnail:'linear-gradient(135deg,#9fd67f,#f7e9a2)', levels:levels(['rescue','golden','exploration']) },
  { id:'world-2', order:2, name:WORLD_NAMES[1], theme:'sakura-city', palette:['#ffd3e8','#f0ddff','#ffe8c7'], skyType:'pink-day', terrain:'city', thumbnail:'linear-gradient(135deg,#ffb4d6,#d6c1ff)', levels:levels(['city_hide','escape','careful']) },
  { id:'world-3', order:3, name:WORLD_NAMES[2], theme:'crystal-lake', palette:['#bde7ff','#d8f4ff','#b8d5ff'], skyType:'clear', terrain:'lake', thumbnail:'linear-gradient(135deg,#91d5ff,#8aa8ff)', levels:levels(['slow_zone','golden','time_attack']) },
  ...
  { id:'world-5', order:5, name:WORLD_NAMES[4], theme:'pastel-port', palette:['#ffd8bf','#cbe7ff','#ffe9f2'], skyType:'sunset', terrain:'port', thumbnail:'linear-gradient(135deg,#ffc9a2,#9fd8ff)', levels:levels(['city_hide','slow_zone','time_attack']) },
  { id:'world-6', order:6, name:WORLD_NAMES[5], theme:'cloud-valley', palette:['#d8ecff','#fbe8ff','#cfe0ff'], skyType:'airy', terrain:'cloudy', thumbnail:'linear-gradient(135deg,#b8d6ff,#f4d4ff)', levels:levels(['mountain_jump','exploration','golden']) },
  ...
  { id:'world-8', order:8, name:WORLD_NAMES[7], theme:'cotton-beach', palette:['#ffe6c6','#bceeff','#ffdaef'], skyType:'beach', terrain:'sand', thumbnail:'linear-gradient(135deg,#ffd9aa,#8de8ff)', levels:levels(['slow_zone','golden','time_attack']) },
  ...
  { id:'world-10', order:10, name:WORLD_NAMES[9], theme:'stellar-village', palette:['#ffddb8','#8a78d4','#2f2d67'], skyType:'starry', terrain:'village-night', thumbnail:'linear-gradient(135deg,#ffca9a,#7361d6)', levels:levels(['city_hide','escape','finale']) },
