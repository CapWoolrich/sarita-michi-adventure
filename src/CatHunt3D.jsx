...
export default function CatHunt3D() {
  ...
  return <div>
    ...
    <WorldMapPanel isOpen={isWorldPanelOpen} worlds={runtime.worlds} currentWorldId={runtime.worldId} unlockedWorldIds={runtime.progress.unlockedWorldIds} progress={runtime.progress} onSelectWorld={runtime.goToWorld} onClose={() => setIsWorldPanelOpen(false)} onLockedWorld={() => setFeedback('Completa el mundo anterior para desbloquearlo')} />
