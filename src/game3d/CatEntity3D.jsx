...
export default function CatEntity3D({ cat, visible, highlight = false }) {
  ...
  return <group ref={ref} position={[cat.x,0.45,cat.z]}>
    <mesh><sphereGeometry args={[0.32,16,16]}/><meshStandardMaterial color={cat.color} emissive={highlight ? '#fff3b0' : '#000000'} emissiveIntensity={highlight ? 0.45 : 0}/></mesh>
    <mesh position={[0.24,0.16,0]}><sphereGeometry args={[0.24,16,16]}/><meshStandardMaterial color={cat.color} emissive={highlight ? '#fff3b0' : '#000000'} emissiveIntensity={highlight ? 0.35 : 0}/></mesh>
