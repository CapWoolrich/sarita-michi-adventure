...
export default function CatEntity3D({ cat, visible, highlight = false }) {
  ...
  return <group ref={ref} position={[cat.x, 0.7, cat.z]} scale={[1.52, 1.52, 1.52]}>
    <mesh><sphereGeometry args={[0.36, 18, 18]} /><meshStandardMaterial color={cat.color} roughness={0.5} emissive={highlight ? '#fff3b0' : '#000000'} emissiveIntensity={highlight ? 0.6 : 0} /></mesh>
